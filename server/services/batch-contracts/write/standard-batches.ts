/**
 * Flujos batch estándar:
 *   - executeBatchCreate         (一括作成 base)
 *   - executeNewHiresCreate      (新規入社一括)
 *   - executeMidHiresCreate      (途中入社一括)
 *   - executeIndividualBatchCreate (1 contrato por employee, sin agrupar)
 */
...
import { buildContractValues } from "./build-values.js";
