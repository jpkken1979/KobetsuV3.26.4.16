...
- No commitear `*.db`, `*.log`, `.env`, `.env.*`, `data/seed/*.json` (con PII real)
- `.env` NO se versiona — solo `.env.example` con placeholders
  (ver `.gitignore` lineas 14-17 y `.claude/rules/security.md`)
