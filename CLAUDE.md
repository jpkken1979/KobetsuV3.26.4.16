...
- **Version:** 26.4.17 (canonical version lives in `ESTADO_PROYECTO.md` — this is the source of truth for changelog and current project status)
...
| 10 | **Grouped PDF Download** (multi-select, by document type) | `/contracts` (multi-select toolbar) | `GroupedDownloadModal` | `POST /documents/generate-grouped` |
...
Instalado por Nexus el 2026-04-30.
